package com.businessincity.commons.helpers
...
import com.businessincity.commons.extensions.getIntValue
import com.businessincity.commons.extensions.getStringValue
import com.businessincity.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.businessincity.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.businessincity.dialer" && packageName != "com.businessincity.smsmessenger" && packageName != "com.businessincity.calendar.pro") {
                return contacts
            }
