...
import com.businessincity.commons.helpers.ensureBackgroundThread
import com.businessincity.commons.helpers.isNougatPlus
import com.businessincity.commons.helpers.sumByInt
import com.businessincity.commons.helpers.sumByLong
...
class PropertiesDialog() {
    ...
    constructor(activity: Activity, path: String, countHiddenItems: Boolean = false) : this() {
        ...
        if (fileDirItem.isDirectory) {
            ...
            if (activity.baseConfig.appId.removeSuffix(".debug") == "com.businessincity.filemanager.pro") {
