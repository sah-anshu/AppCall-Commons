package com.businessincity.commons.activities
...
import com.businessincity.commons.asynctasks.CopyMoveTask
import com.businessincity.commons.dialogs.ConfirmationDialog
import com.businessincity.commons.dialogs.ExportSettingsDialog
import com.businessincity.commons.dialogs.FileConflictDialog
import com.businessincity.commons.dialogs.WritePermissionDialog
import com.businessincity.commons.extensions.*
import com.businessincity.commons.helpers.*
import com.businessincity.commons.interfaces.CopyMoveListener
import com.businessincity.commons.models.FAQItem
import com.businessincity.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.businessincity.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.businessincity.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.businessincity")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.businessincity.")
