...
import com.businessincity.commons.dialogs.ConfirmationAdvancedDialog
import com.businessincity.commons.dialogs.ConfirmationDialog
import com.businessincity.commons.dialogs.RateStarsDialog
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupFacebook() {
        about_facebook.setOnClickListener {
            var link = "https://www.facebook.com/businessincity"
            try {
    ...
    private fun setupReddit() {
        about_reddit.setOnClickListener {
            launchViewIntent("https://www.reddit.com/r/businessincity")
        }
    }
