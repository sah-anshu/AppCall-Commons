...
import com.businessincity.commons.dialogs.*
import com.businessincity.commons.extensions.*
import com.businessincity.commons.helpers.*
import com.businessincity.commons.models.MyTheme
import com.businessincity.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.businessincity.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
