...
import com.businessincity.commons.models.*
import com.businessincity.commons.views.MyTextView
...
fun Activity.launchPurchaseThankYouIntent() {
    try {
        launchViewIntent("market://details?id=com.businessincity.thankyou")
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.businessincity.gallery.pro" || applicationId == "com.businessincity.gallery.pro.debug") {
