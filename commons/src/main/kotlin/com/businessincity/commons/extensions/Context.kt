package com.businessincity.commons.extensions
...
import com.businessincity.commons.helpers.*
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_ACCENT_COLOR
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.businessincity.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.businessincity.commons.models.AlarmSound
import com.businessincity.commons.models.BlockedNumber
import com.businessincity.commons.models.SharedTheme
import com.businessincity.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.businessincity.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.businessincity.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.businessincity.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.businessincity."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.businessincity.contacts") && !packageName.startsWith("com.businessincity.dialer")) {
        true
    } else if ((packageName.startsWith("com.businessincity.contacts") || packageName.startsWith("com.businessincity.dialer")) && isQPlus()) {
